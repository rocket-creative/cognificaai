      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <label htmlFor="payer_type" className={labelClass}>
            Payer type <span className="text-[#737373]">(optional)</span>
          </label>
          <select
        ...
        <div>
          <label htmlFor="member_count" className={labelClass}>
            Member count <span className="text-[#737373]">(optional)</span>
          </label>
          <select
        ...
        <div>
          <label htmlFor="use_case" className={labelClass}>
            Primary use case <span className="text-[#737373]">(optional)</span>
          </label>
          <select
