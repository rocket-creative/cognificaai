...
export function ClinicalReferralBanner() {
  ...
  return (
    <div
      className="w-full bg-orange-grad z-40"
      role="banner"
      ...
      <div className="relative max-w-7xl mx-auto px-4 pr-12 sm:px-6 sm:pr-14 lg:px-8 lg:pr-16 py-2.5 sm:py-3 flex items-center justify-center min-h-[44px]">
        <p className="font-body text-xs sm:text-sm text-white font-light text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-white underline underline-offset-4 hover:no-underline transition-colors focus:outline-none focus-visible:underline font-normal"
        ...
        <button
          onClick={dismiss}
          className="absolute right-4 sm:right-6 lg:right-8 top-1/2 -translate-y-1/2 text-white hover:opacity-80 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-white flex-shrink-0 p-1"
