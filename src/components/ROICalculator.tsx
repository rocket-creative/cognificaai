...
export function ROICalculator() {
  ...
  return (
    <section
      id="roi"
      className="py-24 sm:py-32 bg-[#F5F5F7]"
      aria-labelledby="roi-heading"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="font-nav text-xs tracking-widest uppercase text-orange-grad mb-4">
          ROI Calculator
        </p>
        <h2
          id="roi-heading"
          className="font-heading text-3xl sm:text-4xl lg:text-5xl text-[#0A0A0A] mb-6"
        >
          Calculate Your Cost of Inaction
        </h2>
        <p className="font-body text-sm text-[#6E6E73] font-light mb-12 max-w-2xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <div>
              <label htmlFor="roi-employees" className="block font-body text-xs text-[#515154] mb-2">
                Number of employees
              </label>
              <input
                id="roi-employees"
                ...
                className="w-full h-2 bg-[#E5E5EA] accent-[#3B5A75]"
              />
              <span className="font-body text-sm text-[#0A0A0A]">{employees}</span>
            </div>

            <div>
              <label htmlFor="roi-salary" className="block font-body text-xs text-[#515154] mb-2">
            ...
            <div>
              <label htmlFor="roi-turnover" className="block font-body text-xs text-[#515154] mb-2">
              ...
              <input
                ...
                className="w-full h-2 bg-[#E5E5EA] accent-[#3B5A75]"
              />
              <span className="font-body text-sm text-[#0A0A0A]">{turnoverRate}%</span>
            </div>

            <div>
              <label htmlFor="roi-absentee" className="block font-body text-xs text-[#515154] mb-2">
              ...
              <input
                ...
                className="w-full h-2 bg-[#E5E5EA] accent-[#3B5A75]"
              />
              <span className="font-body text-sm text-[#0A0A0A]">{absenteeDays}</span>
            </div>

            <div>
              <label htmlFor="roi-tier" className="block font-body text-xs text-[#515154] mb-2">
                Pricing tier
              </label>
              <select
                id="roi-tier"
                ...
                autoComplete="off"
                style={{ fontSize: "16px" }}
                className="w-full h-12 bg-white border border-[#D2D2D7] text-[#0A0A0A] px-4 font-body focus:outline-none focus:ring-2 focus:ring-[#3B5A75]"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-[#1a1a1a] p-6 border border-[#D2D2D7]">
              <p className="font-nav text-[10px] tracking-widest uppercase text-[#6E6E73] mb-2">
                Cost of Inaction
              </p>
              <p className="font-heading text-xl sm:text-2xl text-[#0A0A0A]">
                {formatCurrency(results.costOfInaction)}
              </p>
              <p className="font-body text-[10px] text-[#6E6E73] mt-1">annual</p>
            </div>
            <div className="bg-[#F5F5F7] p-6 border border-[#D2D2D7]">
              <p className="font-nav text-[10px] tracking-widest uppercase text-[#6E6E73] mb-2">
                Your Investment
              </p>
              <p className="font-heading text-xl sm:text-2xl text-[#0A0A0A]">
            ...
            <div className="bg-[#222222] p-6 border border-[#D2D2D7]">
              <p className="font-nav text-[10px] tracking-widest uppercase text-[#6E6E73] mb-2">
                Net Benefit
              </p>
              <p className="font-heading text-xl sm:text-2xl text-orange-grad">
                {formatCurrency(results.netBenefit)}
              </p>
              <p className="font-body text-[10px] text-[#6E6E73] mt-1">
        ...
        <p className="font-body text-[10px] text-[#86868B] mt-8 max-w-2xl">
        ...
        <Link
          href="#demo"
          className="inline-flex items-center justify-center gap-4 bg-orange-grad text-white py-3 sm:py-4 px-6 sm:px-8 uppercase tracking-widest text-xs font-light hover:gap-6 transition-all mt-8 focus:outline-none focus:ring-2 focus:ring-[#3B5A75] focus:ring-offset-2 focus:ring-offset-white"
        >
