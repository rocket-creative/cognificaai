      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <label htmlFor="specialty" className={labelClass}>
            Specialty <span className="text-[#737373]">(optional)</span>
          </label>
          <select
        ...
        <div>
          <label htmlFor="patient_panel_size" className={labelClass}>
            Patient panel size <span className="text-[#737373]">(optional)</span>
          </label>
          <select
        ...
        <div>
          <label htmlFor="integration_needed" className={labelClass}>
            EHR integration <span className="text-[#737373]">(optional)</span>
          </label>
          <select
